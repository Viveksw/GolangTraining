...
/* Note : We can une one struct with member 'isAccount' to shpw if that is a current acc or saving acc,
...
1. Two types of account: saving and current
2. saving have interest given to them and current account does not have interest
3. functionalities, which id deposit,, check balance, withdraw, find interest credited
*/
